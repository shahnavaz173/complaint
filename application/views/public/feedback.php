   ...
   <div class="row">
     <div class="col-md-10 col-md-offset-1" style="background-color:#ECE7E7;padding-top:1em;padding-bottom:2em; box-shadow:0px 0px 7px 0px #000;" >
       <div class="col-md-10 col-md-offset-1" style="padding-bottom:1em">
         <h3 style="color:#333"><b>Your Complaint for <span class="text-info"><?=$pending_cid[0]->c_description; ?></span> Has Been Solved. Please Give Us Feedback for improve Our service</b></h3>
       </div>
                 ...
                 <div class="col-md-2 col-md-offset-1">
                   <center>
                     ...
                     <h5><b>Not Satisfied</b></h5>
							 ...
							 <input type="hidden" name="cid" value="<?=$pending_cid[0]->c_id; ?>" />
